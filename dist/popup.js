...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body{\n    min-height: 400px;\n    min-width: 400px;\n}\nh1{\n    color: red;\n}", "",{"version":3,"sources":["webpack://./src/popup/popup.css"],"names":[],"mappings":"AAAA;IACI,iBAAiB;IACjB,gBAAgB;AACpB;AACA;IACI,UAAU;AACd","sourcesContent":["body{\n    min-height: 400px;\n    min-width: 400px;\n}\nh1{\n    color: red;\n}"],"sourceRoot":""}]);
// Exports
...
const Test = () => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null,
            "Hello $",
            count),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { onClick: () => setCount(count + 1) }, "click"),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: "brain.jpg", alt: "", width: "400px" })));
};
